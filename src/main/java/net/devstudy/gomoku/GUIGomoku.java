...
import net.devstudy.gomoku.impl.DefaultComputerTurn;
import net.devstudy.gomoku.impl.DefaultGameTable;
import net.devstudy.gomoku.impl.DefaultHumanTurn;
import net.devstudy.gomoku.impl.DefaultWinnerChecker;
